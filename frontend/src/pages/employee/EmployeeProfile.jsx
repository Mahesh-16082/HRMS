      ...
      <div className="profile-layout-container">
          ...
          <div className="profile-identity-card">
            ...
            <div className="profile-meta-info">
              ...
              <span className="profile-code-text">
                {profile?.employee_code || "Code Pending"}
              </span>
        ...
        <main className="profile-details-main">
          <form onSubmit={handleProfileSubmit} className="profile-details-form">
            ...
            <section className="profile-form-section">
              <div className="profile-section-header">
                ...
                <div>
                  ...
                  <p className="profile-section-desc">Manage your personal and contact details on file.</p>
                </div>
              </div>
            ...
            {/* Section 2: Employment & Organizational Details (Read-only) */}
            <section className="profile-form-section">
              <div className="profile-section-header">
                <div className="section-accent-bar" />
                <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
                  <div>
                    <h3 className="profile-section-title">Employment &amp; Organizational Details</h3>
                    <p className="profile-section-desc">Official company employment records governed by HR.</p>
                  </div>
              ...
              <div className="form-grid">
                <div className="form-group">
                  <label className="form-label">
                    Email Address
                    <span className="readonly-tag">Managed by HR</span>
                  </label>
                  <input
                    type="email"
                    value={user?.email || ""}
